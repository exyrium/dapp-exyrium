...
export default function Home() {
  ...
  return (
    <Container>
      ...
      <br />
      <center>
        <p className="home-title">EXYRIUM</p>
      ...
      <p style={{wordBreak: 'break-word'}}>
        ...
        1. Connect to Vex Wallet. <br />
        2. Make sure you have fund available on Wallet <br />
        3. Enter the contribution amount in VEX <br />
        4. Press Contribute. <br />
        <br />
        OFFICIAL EXYRIUM TOKEN ADDRESS :
        <br />
        <a href='https://vexascan.com/token/EXYRIUM-exyrium.org' target='_blank' rel='noreferrer'>exyrium.org</a>
      </p>
    </Container>
  );
}